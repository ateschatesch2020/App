...
namespace App.Application
{
    public class ServiceResult<T>
    {
        ...
        public static ServiceResult<T> Fail(string errorMessages, HttpStatusCode status = HttpStatusCode.BadRequest)
        {
            return new ServiceResult<T>
            {
                ErrorMessages = [errorMessages], // new List<string> { errorMessages },.NET 8.0+ collection initializer syntax
                Status = status,
